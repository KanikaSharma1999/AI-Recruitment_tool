const STATUS_MAP = {
  ...
  'interview_analyzing':{ cls: 'badge-screening',   label: 'Analyzing Interview...' },
  'interview_analyzed': { cls: 'badge-completed',   label: 'Interview Analyzed' },
  'interview_incomplete':{ cls: 'badge-rejected',   label: 'Interview Incomplete' },
